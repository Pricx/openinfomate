    ...
    return {
        ...
        "llm.priority_lane.policy": PromptTemplate(
            ...
            text_zh=(
                ...
                "不要 alert：集成指南/教程/SDK 文档、例行上新（无重大变化）。\n"
            ...
            text_en=(
                ...
                "Do NOT alert integration guides/tutorials/SDK docs or routine vendor announcements (no material change).\n"
        ...
        "llm.gate_alert.system": PromptTemplate(
            ...
            text_zh=(
                ...
                "- 不要 alert：集成指南/教程、例行上新、广告/投放/营销平台集成（除非有可迁移通用治理增量）、单一小众软件 RCE、泛泛的 OAuth 滥用报告。\n"
            ...
            text_en=(
                ...
                "- Do NOT alert integration guides/tutorials, routine vendor announcements, ads/marketing platform integrations (unless transferable governance), single niche-software RCEs, or generic OAuth abuse reports.\n"
        ...
        "llm.curate_items.system": PromptTemplate(
            ...
            text_zh=(
                ...
                "- 不要 alert：集成指南/教程/SDK 文档、例行上新（无重大变化）、广告/投放/营销平台集成（除非有可迁移通用治理增量）、单一小众软件 RCE、泛泛的 OAuth 滥用报告。\n"
            ...
            text_en=(
                ...
                "- Do NOT alert integration guides/tutorials/SDK docs, routine vendor announcements (no material change), ads/marketing platform integrations (unless transferable governance), single niche-software RCEs, or generic OAuth abuse reports.\n"
